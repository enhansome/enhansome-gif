...
* [Gif-h](https://github.com/charlietangora/gif-h) ⭐ 544 | 🐛 7 | 🌐 C | 📅 2026-09-18 - C++ one-header library for the creation of animated GIFs.
* [msf\_gif](https://github.com/notnullnotvoid/msf_gif) ⭐ 239 | 🐛 2 | 🌐 C | 📅 2025-09-10 - C/C++ single-header library for creating animated GIFs.
...
* [Gif.js](https://github.com/jnordberg/gif.js) ⭐ 4,977 | 🐛 94 | 🌐 JavaScript | 📅 2023-10-06 - Create GIF from the DOM.
...
* [FLAnimatedImage](https://github.com/Flipboard/FLAnimatedImage) ⭐ 7,943 | 🐛 83 | 🌐 Objective-C | 📅 2024-03-21 - GIF engine for iOS by FlipBoard.
...
[yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,909 | 🐛 2,664 | 🌐 Python | 📅 2026-09-16
...
Based on a [recovered list](https://github.com/sindresorhus/awesome/issues/872) ⭐ 508,929 | 🐛 106 | 📅 2026-09-02 by [Ismail Baaj](https://ismailbaaj.fr).
