...
* [gifski](https://github.com/ImageOptim/gifski) ⭐ 5,623 | 🐛 36 | 🌐 Rust | 📅 2026-06-17 - High-quality GIF encoder based on libimagequant.
...
* [FLAnimatedImage](https://github.com/Flipboard/FLAnimatedImage) ⭐ 7,951 | 🐛 83 | 🌐 Objective-C | 📅 2024-03-21 - GIF engine for iOS by FlipBoard.
...
[yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 189,155 | 🐛 2,632 | 🌐 Python | 📅 2026-08-30
...
Based on a [recovered list](https://github.com/sindresorhus/awesome/issues/872) ⭐ 503,230 | 🐛 106 | 📅 2026-09-02 by [Ismail Baaj](https://ismailbaaj.fr).
